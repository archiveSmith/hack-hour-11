...
The door to
this warehouse is secured by an electronic combination lock.
Unfortunately our spy isn't sure about the
...
PINs, they
never finally lock the system or sound the alarm. That's why we can try out all
possible (*) variations.
...
function getPINs(observed) {
  ...
  let parsedMax = JSON.stringify(Math.max.apply(JSON.parse(observed).split('')))
}
