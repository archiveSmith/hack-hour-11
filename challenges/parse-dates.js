...
// parseDates('Jan 12th 1:09 AM')  => returns new Date object representing
//'Mon Jan 12 2015 01:09:00 GMT-0800 (PST)'
// parseDates('Today 8:15 PM')     => returns new Date object representing
//'Thu Dec 17 2015 20:15:00 GMT-0800 (PST)'
// parseDates('Sunday 12:59 PM')   => returns new Date object representing
//'Sun Dec 13 2015 12:59:00 GMT-0800 (PST)'

// parseDates('Jan 1st')
// parseDates('hello')
// parseDates('Today 2 PM')        => invalid formats, so all return Date object
//for today at the current time: 'Thu Dec 17 2015 11:31:00 GMT-0800 (PST)'
...
//   (i.e. the function will not be called with 'Jul 84th 1:00 PM') since that's
//not a real date
